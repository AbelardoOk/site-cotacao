export default function Home() {
  return (
    <main className="flex items-center justify-center h-screen">
      ...
      <div className="w-[670px] h-[355px] p-8 bg-black rounded-[40px]">
          ...
          <div>
            <form>
              <div>
                ...
                <input className="w-[96px] h-[48px] bg-black rounded-l-[8px] text-center border-[#5AFB3A] border-l-2 border-t-2 border-b-2"
                type="number" id='valor' placeholder="Valor" />

                <select className="bg-black text-center w-[160px] h-[48px] border-2 border-[#5AFB3A]"
